...
Lfp, speed, gain = load_data(binFullPath,HPC_path_file,PFC_path_file,"HPC",sess)
...
# stack 1 min Lfp for low speed trials into a 4D array: nch, min id, id trial, length trial,
...
# stack 1 min Lfp for high speed trials into a 4D array: nch, min id, id trial, length trial,
lfp_B_ep_high_s, lfp_L_ep_high_s, lfp_M_ep_high_s, lfp_H_ep_high_s = stack_lfp_1min(lfp_B_ep_high_s, lfp_L_ep_high_s, lfp_M_ep_high_s, lfp_H_ep_high_s, lfp_B_list, lfp_L_list, lfp_M_list, lfp_H_list)
