...
"""
**** CHOOSE YOUR CHANNEL LIST HERE, for each stratum -- This is different for each session ****
...
save_list_channel_CA1(idx_cell_hpc, rec, sess, 'HPC')
...
"""
Phase extraction for each LFP averaged in each layer
"""
...
"""
Downsample phase to 250 Hz -- original phase at 1250 Hz
"""
...
# for idx in range(0,1):
    ...
    stratum_name = ["oriens","pyramidale","radiatum","LocMol"]
